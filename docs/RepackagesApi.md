# io.pharmatrace.api.scin.public\RepackagesApi
...
# **AddRepackage**
> Repackage AddRepackage(ctx, repackage)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of repackage to delete | 
...
# **FindRepackageById**
> Repackage FindRepackageById(ctx, id)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of repackage to fetch | 
...
# **FindRepackages**
> []Repackage FindRepackages(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***FindRepackagesOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a FindRepackagesOpts struct
