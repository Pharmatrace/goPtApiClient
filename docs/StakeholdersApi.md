# io.pharmatrace.api.scin.public\StakeholdersApi
...
# **AddStakeholder**
> Stakeholder AddStakeholder(ctx, stakeholder)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of stakeholder to delete | 
...
# **FindStakeholderById**
> Stakeholder FindStakeholderById(ctx, id)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of stakeholder to fetch | 
...
# **FindStakeholders**
> []Stakeholder FindStakeholders(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***FindStakeholdersOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a FindStakeholdersOpts struct
