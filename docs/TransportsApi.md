# io.pharmatrace.api.scin.public\TransportsApi
...
# **AddTransport**
> Transport AddTransport(ctx, transport)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of transport to delete | 
...
# **FindTransportById**
> Transport FindTransportById(ctx, id)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **id** | **int64**| ID of transport to fetch | 
...
# **FindTransports**
> []Transport FindTransports(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***FindTransportsOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a FindTransportsOpts struct
